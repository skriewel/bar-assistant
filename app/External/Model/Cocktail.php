...
readonly class Cocktail implements SupportsDataPack, SupportsSchema4, SupportsJSONLD
{
    ...
    public static function fromDataPackArray(array $sourceArray): self
    {
        ...
        return new self(
            id: $sourceArray['_id'] ?? Str::slug($sourceArray['name']),
            name: $sourceArray['name'],
            instructions: $sourceArray['instructions'],
            createdAt: $sourceArray['created_at'] ?? null,
            updatedAt: $sourceArray['updated_at'] ?? null,
            description: $sourceArray['description'] ?? null,
            source: $sourceArray['source'] ?? null,
            publication: $sourceArray['publication'] ?? null,
            garnish: $sourceArray['garnish'] ?? null,
            abv: $sourceArray['abv'] ?? null,
            tags: $sourceArray['tags'] ?? [],
            glass: $sourceArray['glass'] ?? null,
            method: $sourceArray['method'] ?? null,
            utensils: $sourceArray['utensils'] ?? [],
            images: $images,
